...
disp("Running FinalProject_NewTask")
...
Tsc_final = [1 0 0 1%block position
            0 1 0 0
            0 0 1 0.025
            0 0 0 1];
        
Tsc_init = [0 1 0 0%block position
            -1 0 0 -1
            0 0 1 0.025
            0 0 0 1];   
...
writematrix(forcsv ,'NewTask_Trajectory Generation Gripper.csv')
